...
public class Vraag {
    ...
    public void VragenBeantwoorden() {
        ...
        for (int i = 0; i < meerkeuzeVragen.length; i++) {
            ...
            for (int j = 0; j < meerkeuzeOpties[i].length; j++) {
                System.out.println((char) ('a' + j) + ") " + meerkeuzeOpties[i][j]);
            }
            System.out.print("Maak je keuze (bijv. abc): ");
            String antwoord = scanner.nextLine();
            antwoorden.add(antwoord);
        }
    }
